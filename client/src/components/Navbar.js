...
class Navbar extends Component {
  ...
  selectDepartment(level, text, value) {
    this.setState({ selectedDepartmentLevel: level, selectedDepartmentText: text, selectedDepartmentValue: value });
  }
            ...
            <div className="input-group">
              <div className="input-group-prepend">
                ...
                <div className="dropdown-menu dropdown-search">
                  <span className="dropdown-item dropdown-category" onClick={() => this.selectDepartment('category', 'All departments', 'gaming')}>All departments</span>
